...
Heightfield.prototype.getCacheConvexTrianglePillarKey = (xi, yi, getUpperTriangle) => `${xi}_${yi}_${getUpperTriangle ? 1 : 0}`;

Heightfield.prototype.calculateLocalInertia = (mass, target) => {
    target = target || new Vec3();
    target.set(0, 0, 0);
    return target;
};

Heightfield.prototype.volume = () => // The terrain is infinite
Number.MAX_VALUE;

Heightfield.prototype.calculateWorldAABB = (pos, quat, min, max) => {
    // TODO: do it properly
